...
(* Claude: "Notation" for an abbreviation is deprecated in Rocq 9.2 *)
Abbreviation G_nil := (@nil (termvar*T)).
...
(* Claude: create the database rather than letting the Hint declare it
   implicitly, which Rocq 9.2 deprecates, and give the hint a locality *)
Create HintDb rules.
#[export] Hint Constructors reduce GtT : rules.
